...
const tabContentSiblings =
  document.querySelector('.tab__content').parentElement.children;
...
tabContainer.addEventListener('click', function (e) {
  if (e.target.tagName === 'A') {
    ...
    document
      ...
      .forEach((tab) => tab.classList.remove('activeTabContent'));
...
const stickyNav = function (enteries, observer) {
  enteries.forEach((entry) => {
    ...
    if (entry.isIntersecting) {
      ...
      tabs[index].classList.contains('active') &&
